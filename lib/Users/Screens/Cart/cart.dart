                        ...
                        children: [
                         ...
                         DropdownButtonHideUnderline (
                                                        child: DropdownButton(
                                                          ...
                                                          hint: const Text('Delivery',style: TextStyle(fontSize: 11,color: Colors.black,fontWeight: FontWeight.w500),),
                        ...
                        children: [
                         ...
                         DropdownButtonHideUnderline (
                                                        child: DropdownButton(
                                                          style: const TextStyle(fontSize: 11,color: Colors.black,fontWeight: FontWeight.w500),
                                                          icon: const Icon(Icons.arrow_drop_down,size: 18,),
                                                          hint: const Text('Yes',style: TextStyle(fontSize: 11,color: Colors.black,fontWeight: FontWeight.w500),),
                    ...
                    child: Column(children: <Widget>[  
                      Container(  
                        ...
                        child: Table(  
                          ...
                          children: [  
                            TableRow( children: [  
                              Column(children:const [Text('Order Amount', style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600))]),  
                              Column(children:const [Text('Note', style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600))]),  
                              Column(children:const [Text('Delivery Charge', style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600))]),  
                            ]),  
                            TableRow( children: [  
                              Column(children:const [Text('Rs. 1 to 200', style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500))]),  
                              Column(children:const [Text('Free Delivery not Available', style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500))]),  
                              Column(children:const [Text('Rs. 20/km', style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500))]),  
                            ]),  
                            TableRow( children: [  
                              Column(children:const [Text('Rs. 1 to 200', style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500))]),  
                              Column(children:const [Text('Free Delivery not Available', style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500))]),  
                           ...
                           child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                             children: [
                              ...
                              const SizedBox(width: 5,),
                               const Text('Login & Signup',textAlign: TextAlign.center, 
