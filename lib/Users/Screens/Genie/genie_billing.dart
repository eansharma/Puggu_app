                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                             Row(
                                  children: const [
                                    Text('Delivery Charge for 9 km',style: TextStyle(fontSize: 10,fontWeight: FontWeight.w400,color: Colors.black),),
                                  Spacer(),
                                  Text('\$457',style: TextStyle(fontSize: 10,fontWeight: FontWeight.w400,color: Colors.black),),
                                  ],
                                ),
