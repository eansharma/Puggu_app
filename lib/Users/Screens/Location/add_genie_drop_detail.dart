...
class AddGenieDropDetail extends StatefulWidget {
  const AddGenieDropDetail({Key? key, required String title}) : super(key: key);

  @override
  _AddGenieDropDetailState createState() => _AddGenieDropDetailState();
}

class _AddGenieDropDetailState extends State<AddGenieDropDetail> {
