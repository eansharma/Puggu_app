...
class AddGenieDropLocation extends StatefulWidget {
  const AddGenieDropLocation({Key? key, required String title}) : super(key: key);

  @override
  _AddGenieDropLocationState createState() => _AddGenieDropLocationState();
}

class _AddGenieDropLocationState extends State<AddGenieDropLocation> {
                       ...
                       child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                         children: const [
                           ...
                           Text('SAVE DROP ADDRESS',style: TextStyle(fontSize: 12,fontWeight: FontWeight.w400,color: Colors.white),),
