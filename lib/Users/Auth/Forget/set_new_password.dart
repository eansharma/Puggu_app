                          ...
                          SizedBox(height: 30,
                                 ...
                                 //<-- SEE HERE
                                  ...
                                  //<-- SEE HERE
                                                    ...
                                                    const Text('Confirm New Password',style: TextStyle(fontSize: 11,fontWeight: FontWeight.w500,color: Colors.black),),
                        const SizedBox(height: 10,),
                          SizedBox(height: 30,
                                                    child: TextFormField(
                                                      obscureText: true,
                       ...
                       child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                         children: const [
                           ...
                           Text('Save Password',style: TextStyle(fontSize: 14,fontWeight: FontWeight.w700,color: Colors.white),),
