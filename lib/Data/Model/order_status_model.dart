class OrderStatusModel {
	...
	OrderStatusModel({this.data, this.riderDetail, this.status, this.message});

	OrderStatusModel.fromJson(Map<String, dynamic> json) {
		data = json['data'] != null ? new Data.fromJson(json['data']) : null;
		riderDetail = json['rider_detail'] != null ? new RiderDetail.fromJson(json['rider_detail']) : null;
		status = json['status'];
	...
	Map<String, dynamic> toJson() {
      ...
      data['data'] = this.data!.toJson();
		...
		if (this.riderDetail != null) {
      data['rider_detail'] = this.riderDetail!.toJson();
    }
...
class OrderRiderDetail {
	...
	OrderRiderDetail({this.id, this.riderId, this.orderId, this.userId, this.point, this.comment, this.deliveryPoint, this.createdAt, this.updatedAt});
